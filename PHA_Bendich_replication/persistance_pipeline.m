...
load([data_path,'/d10/H0Persistance_d10.mat']);
load([data_path,'/d10/H1Persistance_d10.mat']);
Ages = load([data_path,'/age_array.mat']);
Ages = Ages.age';
Sexes = load([data_path,'/sex_array.mat']);
Sexes = Sexes.sex';
InfarctSizes = load([data_path, '/infarct_volumes.mat']);
InfarctSizes = InfarctSizes.infarct_volume';
...
fprintf('Pearson p-value of H0 Features vs Infarct Siz:             %d\n\n',  H0_infarct_size_pval);

fprintf('Pearson Correlation of H1 Features vs Infarct Siz:         %d\n',    H1_infarct_size_rho);
fprintf('Pearson p-value of H1 Features vs Infarct Siz:             %d\n\n',  H1_infarct_size_pval);
