...
for subject in subjects:
    ...
    for modality in modalities:
        ...
        if modality.startswith('Ct'):
            spc_files = [i for i in os.listdir(modality_dir) if os.path.isfile(os.path.join(modality_dir, i)) and i.startswith(spc_start)]
            angio_files = [i for i in os.listdir(modality_dir) if os.path.isfile(os.path.join(modality_dir, i)) and i.startswith(angio_start)]
